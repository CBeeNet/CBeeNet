...
:root {{
  ...
  --border-glow: rgba(180, 80, 255, 0.25);
  --text: #f0edff;
  --text2: #b8b0d0;
  --text3: #6f6888;
  --primary: #a855f7;
...
.logo-wrap {{
  ...
  font-size: 40px;
  color: #fff;
  box-shadow: 0 0 0 6px rgba(168,85,247,0.2), 0 20px 50px rgba(168,85,247,0.3);
...
.btn-copy:hover {{ transform: scale(1.05); box-shadow: 0 4px 15px rgba(168,85,247,0.3); }}
