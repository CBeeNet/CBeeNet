...
.grid{position:fixed;inset:0;background-image:linear-gradient(rgba(239,68,68,0.04) 1px,transparent 1px),linear-gradient(90deg,rgba(239,68,68,0.04) 1px,transparent 1px);background-size:44px 44px;z-index:0}
.orb{position:fixed;border-radius:50%;filter:blur(90px);z-index:0;animation:fl 9s ease-in-out infinite}
.o1{width:380px;height:380px;background:rgba(239,68,68,0.07);top:-100px;right:-80px}
...
.card{background:var(--card);border:1px solid var(--border);border-radius:20px;padding:38px 34px 34px;backdrop-filter:blur(24px);box-shadow:0 0 80px rgba(239,68,68,0.07),0 20px 60px rgba(0,0,0,.5)}
.brand{display:flex;align-items:center;gap:14px;margin-bottom:28px}
.brand-img{width:48px;height:48px;border-radius:13px;overflow:hidden;border:1px solid var(--border);box-shadow:0 0 20px rgba(239,68,68,0.3);flex-shrink:0}
...
.hint{display:flex;align-items:center;gap:10px;background:rgba(239,68,68,0.07);border:1px solid rgba(239,68,68,0.15);border-radius:10px;padding:10px 14px;margin-bottom:20px}
.hint-label{font-size:11px;color:var(--dim);flex:1}
.hint-val{font-family:ui-monospace,monospace;font-size:14px;font-weight:700;color:var(--accent);background:rgba(239,68,68,0.1);border:1px solid rgba(239,68,68,0.25);padding:3px 11px;border-radius:7px;cursor:pointer;transition:.15s;letter-spacing:.08em}
.hint-val:hover{background:rgba(239,68,68,0.22)}
...
input[type=password]:focus{border-color:rgba(239,68,68,.55);background:rgba(0,0,0,.4);box-shadow:0 0 0 3px rgba(239,68,68,.1)}
...
.nav-badge{margin-right:auto;background:rgba(239,68,68,0.15);color:var(--accent2);font-size:9px;padding:1px 6px;border-radius:20px;font-weight:700}
...
.traf-range-tab.on{background:var(--accent);color:#fff;box-shadow:0 2px 8px rgba(239,68,68,.35)}
...
.btn-p{background:var(--accent);color:#fff;box-shadow:0 2px 12px rgba(239,68,68,.3)}
.btn-p:hover{background:#2563EB;box-shadow:0 4px 18px rgba(239,68,68,.4)}
.btn-o{background:transparent;border:1px solid var(--card-b);color:var(--t2)}
.btn-o:hover{background:var(--accent-d);border-color:rgba(239,68,68,.3)}
.btn-g{background:var(--accent-d);color:var(--accent2);border:1px solid rgba(239,68,68,.15)}
.btn-g:hover{background:rgba(239,68,68,.22)}
...
.sr{display:flex;align-items:center;justify-content:space-between;padding:9px 0;border-bottom:1px solid rgba(239,68,68,0.05);font-size:12px}
...
.fi:focus,.fs:focus{border-color:rgba(239,68,68,.45);background:rgba(0,0,0,.25);box-shadow:0 0 0 3px rgba(239,68,68,.08)}
.fs option{background:var(--bg2)}
[data-theme="light"] .fs option{background:#fff}
.cl{background:var(--accent-d);border:1px solid rgba(239,68,68,.15);border-radius:10px;padding:11px 13px;font-size:11px;color:var(--t2);display:flex;gap:9px;align-items:flex-start;line-height:1.8;margin-top:12px}
...
.cp-head-icon{width:44px;height:44px;border-radius:13px;background:linear-gradient(135deg,var(--accent),var(--accent2));display:flex;align-items:center;justify-content:center;color:#fff;font-size:20px;flex-shrink:0;box-shadow:0 6px 18px rgba(239,68,68,.35)}
...
.cp-input-full:focus{border-color:rgba(239,68,68,.5);box-shadow:0 0 0 3px rgba(239,68,68,.1)}
...
.chip:hover{background:rgba(239,68,68,.18);color:var(--accent2)}
.chip.active{background:var(--accent);color:#fff;border-color:var(--accent);box-shadow:0 3px 10px rgba(239,68,68,.35)}
...
.proto-card.active{border-color:var(--accent);background:var(--accent-d);box-shadow:0 0 0 3px rgba(239,68,68,.1)}
...
.cp-submit-btn{background:linear-gradient(135deg,var(--accent),var(--accent2));color:#fff;border:none;border-radius:13px;padding:13px 26px;font-family:inherit;font-size:13px;font-weight:800;cursor:pointer;display:flex;align-items:center;gap:8px;box-shadow:0 6px 20px rgba(239,68,68,.35);transition:.18s;white-space:nowrap}
.cp-submit-btn:hover{transform:translateY(-2px);box-shadow:0 10px 26px rgba(239,68,68,.45)}
...
.srv-hero-icon{width:50px;height:50px;border-radius:14px;background:linear-gradient(135deg,var(--accent),var(--accent2));display:flex;align-items:center;justify-content:center;color:#fff;font-size:22px;flex-shrink:0;box-shadow:0 6px 18px rgba(239,68,68,.35)}
...
.modal-v2-hint{background:rgba(239,68,68,.08);border:1px solid rgba(239,68,68,.18);border-radius:11px;padding:9px 12px;font-size:10px;color:var(--t2);display:flex;gap:7px;align-items:flex-start;line-height:1.6;margin-top:2px}
...
.lmodal-icon{width:44px;height:44px;border-radius:13px;background:linear-gradient(135deg,var(--accent),var(--accent2));display:flex;align-items:center;justify-content:center;color:#fff;font-size:19px;flex-shrink:0;box-shadow:0 6px 16px rgba(239,68,68,.35)}
...
.lmodal-search input:focus{border-color:rgba(239,68,68,.5);box-shadow:0 0 0 3px rgba(239,68,68,.1)}
...
.lmodal-qbtn:hover{background:rgba(239,68,68,.2)}
...
.lrow-v2.checked{background:rgba(239,68,68,.1);border-color:rgba(239,68,68,.25)}
...
.lrow{display:flex;align-items:center;gap:8px;padding:7px 0;border-bottom:1px solid rgba(239,68,68,.05)}
...
.cfg-uuid-mini:hover{background:rgba(239,68,68,.2)}
...
.ubar{height:5px;border-radius:4px;background:rgba(239,68,68,0.1);overflow:hidden}
...
.log-item{display:flex;gap:12px;padding:11px 0;border-bottom:1px solid rgba(239,68,68,.05);position:relative}
...
.erow{padding:9px 0;border-bottom:1px solid rgba(239,68,68,.05)}
...
<section class="pg on" id="pg-overview">
  ...
  <div class="dash-footer">
    <span class="df-text">VaslZone VaslZone Gateway v9.3 · Railway · 2025</span>
...
function initCharts(){
  ...
  const grad1=makeGradient(c1,'rgba(239,68,68,.38)','rgba(239,68,68,0)');
  const opts={
    ...
    plugins:{
      ...
      tooltip:{
        backgroundColor:'rgba(13,27,46,.96)',borderColor:'rgba(239,68,68,.3)',borderWidth:1,
    ...
    scales:{
      ...
      y:{grid:{color:'rgba(239,68,68,.06)'},border:{display:false},ticks:{color:'#3D6B8E',font:{size:9,family:'Vazirmatn'},callback:v=>v+' MB'}}
    },
  ...
  const gradFill3=makeGradientV2(c3ctx,'rgba(239,68,68,.45)','rgba(239,68,68,.08)','rgba(239,68,68,0)');
  ch3=new Chart(document.getElementById('ch3'),{
    ...
    options:{
      ...
      plugins:{
        legend:{display:false},
        tooltip:{
          backgroundColor:'rgba(13,27,46,.97)',borderColor:'rgba(239,68,68,.35)',borderWidth:1,
      ...
      scales:{
        ...
        y:{grid:{color:'rgba(239,68,68,.05)'},border:{display:false},ticks:{color:'#3D6B8E',font:{size:9.5,family:'Vazirmatn'},callback:v=>v+' MB'}}
      }
    }
  });
  ...
  ch2=new Chart(document.getElementById('ch2'),{
    ...
    options:{
      ...
      plugins:{
        ...
        tooltip:{backgroundColor:'rgba(13,27,46,.96)',borderColor:'rgba(239,68,68,.3)',borderWidth:1,padding:10,cornerRadius:10,bodyFont:{family:'Vazirmatn'},titleFont:{family:'Vazirmatn'}}
      }
    }
  });
}
...
<title>VaslZone Sub · vaslzone</title>
<link rel="preconnect" href="https://fonts.googleapis.com">
...
<div class="wrap">
  ...
  <div class="footer">کانال رسمی: <a href="https://t.me/VaslZone" target="_blank">@VaslZone</a> · VaslZone Gateway v9.2</div>
</div>
<script>
...
function renderContent(d){{
  ...
  window._VaslZoneSubUrl  = subUrl;
  window._VaslZoneSubName = d.name;
  window._VaslZoneLinks   = d.links.map(l => ({{
    vless : l.vless_link,
    ...
    <div class="sub-info">
      ...
      <div class="sub-sub-box">
        ...
        <button class="btn btn-pur" style="padding:7px 12px;font-size:10.5px"
          onclick="navigator.clipboard.writeText(window._VaslZoneSubUrl).then(()=>toast('لینک ساب کپی شد ✓','ok'))">
          <i class="ti ti-copy"></i> کپی لینک ساب
        </button>
        <button class="btn btn-g" style="padding:7px 12px;font-size:10.5px"
          onclick="showQR(window._VaslZoneSubName + ' — کل گروه', window._VaslZoneSubUrl)">
            ...
            <div class="cfg-bottom">
              ...
              <div class="cfg-actions">
                <button class="btn btn-p"
                  onclick="navigator.clipboard.writeText(window._VaslZoneLinks[${{i}}].vless).then(()=>toast('لینک کپی شد ✓','ok'))">
                  <i class="ti ti-copy"></i> کپی لینک
                </button>
                <button class="btn btn-g"
                  onclick="showQR(window._VaslZoneLinks[${{i}}].label, window._VaslZoneLinks[${{i}}].vless)">
